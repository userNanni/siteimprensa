...
/* harmony import */ var next_dist_compiled_react_server_dom_webpack_server_edge__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(6370);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 4841)), "C:\\Users\\Nanni\\Desktop\\SiteImprensa\\interafaNews\\interafanews\\src\\app\\gallerie\\page.tsx"],
    ...
    const pages = ["C:\\Users\\Nanni\\Desktop\\SiteImprensa\\interafaNews\\interafanews\\src\\app\\gallerie\\page.tsx"];
...
async function getNews() {
    const res = await fetch("http://127.0.0.1:8090/api/collections/news/records", {
        cache: "no-store"
    });
...
function Newsf({ news  }) {
    const { collectionId , id , title , image  } = news || {};
...
var __webpack_exports__ = __webpack_require__.X(0, [67,1,94], () => (__webpack_exec__(5421)));
